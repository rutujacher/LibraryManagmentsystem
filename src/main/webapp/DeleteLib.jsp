...
<h3 align="center">Delete Librarian</h3>
  <form action="/deleteLibrarians" style="width:300px;margin-left:40%;margin-right:40%;">
   <div class="form-group">
    <label for="librarian id">Librarian Id</label>
    <input type="text" class="form-control" name="lid" placeholder="Librarian Id"/>
  </div>
