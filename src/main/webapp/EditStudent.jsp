...
<h3 align="center">Edit Student</h3>
  <form action="/editStudent" method="post" style="width:300px;margin-left:40%;margin-right:40%;">
   <div class="form-group">
    <label for="student id">Student Id</label>
    <input type="text" class="form-control" name="stud_id" id="enrollment" placeholder="Student Id"/>
  </div>
  <div class="form-group">
